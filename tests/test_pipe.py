...
def test_2d_time_tran():
    ...
    dic,data = ng.pipe.read("common_data/2d_pipe/test_tp.fid")
...
def test_3d_slicing():
    ...
    assert_array_equal(fdata[-1:-100:-3,-1::-1,0],data[-1:-100:-3,-1::-1,0])
...
def test_4d_single_index_time():
    ...
    fmask = "common_data/4d_pipe/time_1index/test%03d.fid"
    dic,data = ng.pipe.read_lowmem(fmask)

    fname = "common_data/4d_pipe/time_1index/test018.fid"
...
def test_4d_single_index_freq():
    ...
    fmask = "common_data/4d_pipe/ft_1index/test%03d.ft4"
    dic,data = ng.pipe.read_lowmem(fmask)

    fname = "common_data/4d_pipe/ft_1index/test053.ft4"
    sdic,sdata = ng.pipe.read(fname)
...
def test_4d_stream_index_freq():
    ...
    fmask = "common_data/4d_pipe/full4D.ft4"
    dic,data = ng.pipe.read_lowmem(fmask)
