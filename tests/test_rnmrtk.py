...
def test_1d_time():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + 'rnmrtk_1d/time_1d.sec')
...
def test_1d_freq():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + 'rnmrtk_1d/freq_1d.sec')
...
def test_2d_time():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + "rnmrtk_2d/time_2d.sec")
...
def test_2d_freq():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + "rnmrtk_2d/freq_2d.sec")
...
def test_2d_time_lowmem():
    ...
    dic, data = ng.rnmrtk.read_lowmem(DATA_DIR + "rnmrtk_2d/time_2d.sec")
    assert data.shape == (332, 1500) 
    assert round(data[0, 1].real, 2) == 360.07 
    assert round(data[0, 1].imag, 2) == -223.20
    assert round(data[10, 18].real, 2) == 17.93
...
def test_2d_freq_lowmem():
    ...
    dic, data = ng.rnmrtk.read_lowmem(DATA_DIR + "rnmrtk_2d/freq_2d.sec")
    assert data.shape == (2048, 4096) 
    assert round(data[0, 1], 2) == -.19 
    assert round(data[10, 18], 2) == 0.88
    assert dic['sw'][1] == 50000.0
...
def test_3d_time():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + "rnmrtk_3d/time_3d.sec")
...
def test_3d_freq():
    ...
    dic, data = ng.rnmrtk.read(DATA_DIR + "rnmrtk_3d/freq_3d.sec")
...
def test_3d_time_lowmem():
    ...
    dic, data = ng.rnmrtk.read_lowmem(DATA_DIR + "rnmrtk_3d/time_3d.sec")
    assert data.shape == (128, 88, 1250)
    assert round(data[0, 1, 2].real, 2) == 7.98
    assert round(data[0, 1, 2].imag, 2) == 33.82
    assert round(data[10, 11, 18].real, 2) == -9.36
...
def test_3d_freq_lowmem():
    ...
    dic, data = ng.rnmrtk.read_lowmem(DATA_DIR + "rnmrtk_3d/freq_3d.sec")
    assert data.shape == (128, 128, 4096)
    assert round(data[0, 1, 2], 2) == 3.23
    assert round(data[10, 11, 18], 2) == 1.16
    assert dic['sw'][2] == 50000.0
